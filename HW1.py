...
fb_2015 = pd.read_csv('2021 UVA Football Data-selected\\2015 PFF All Plays.csv', index_col=0)
"""
...
ep_columns = []
fb_2015_EP = fb_2015[ep_columns]
# print(fb_2015_EP)


# Find type of a column
print(fb_2015['pff_WEEK'].apply(type))
...
print("\nMIXED TYPES: \n")
all_mixed_df = fb_2015.iloc[:,column_index]
