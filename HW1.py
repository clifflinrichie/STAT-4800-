...
trainFile = r"C:\Users\joshj\Downloads\2019 PFF All Plays.csv"
os.chdir(os.path.dirname(trainFile))
fb_2019 = pd.read_csv(os.path.basename(trainFile))
fb_2019 = fb_2019.dropna(subset=['pff_PASSRESULT'])
print(fb_2019['pff_PASSRESULT'])
a = fb_2019['pff_PASSRESULT']
